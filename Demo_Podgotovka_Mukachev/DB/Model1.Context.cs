...
namespace Demo_Podgotovka_Mukachev.DB
{
    using System;
    ...
    public partial class vosmerka_demo_MukachevEntities : DbContext
    {
        public vosmerka_demo_MukachevEntities()
            : base("name=vosmerka_demo_MukachevEntities")
        {
        }
