...
namespace Fayzullina_Elvina_Rafaelevna.Models
{
    ...
    public partial class Fayzullina_Elvina_RafaelevnaEntities : DbContext
    {
        public Fayzullina_Elvina_RafaelevnaEntities()
            : base("name=Fayzullina_Elvina_RafaelevnaEntities")
        {
        }
